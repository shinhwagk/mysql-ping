...
curl -XPOST http://127.0.0.1:3003 -d '["n=test1,r=60,u=root,p=root_password,h=192.168.161.93,P=33126","n=test2,r=10,u=root,p=root_password,h=192.168.161.93,P=33026"]'
```
