```sh
## ping service
bun run mysqlping_server.ts --follower-ping fp1 --export-port 3000 --ping-range 60 --source-dsns name1@root:root_password@192.168.161.93:33026,name2@root:root_password@192.168.161.93:33026
